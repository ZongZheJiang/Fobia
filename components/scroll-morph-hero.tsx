...
const IMAGES = [
    ...
    "https://avatars.slack-edge.com/2025-05-14/8891273522918_30c38bf627ac73075db6_512.png",
    "https://databar.ai/media/external_source_logo/OpenAI.png",
    "https://cdn.prod.website-files.com/673728fe79d73c09073776cb/6964e9752cbbf9bfc392f5e5_deepseek-blog-cover.webp",
    "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=300&q=80",
    "https://images.unsplash.com/photo-1506765515384-028b60a970df?w=300&q=80",
    "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=300&q=80",
    "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=300&q=80",
    "https://smythos.com/wp-content/uploads/2025/07/KIMI-K2.jpg",
    "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=300&q=80",
    "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=300&q=80",
    "https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?w=300&q=80",
    "https://images.unsplash.com/photo-1465146344425-f00d5f5c8f07?w=300&q=80",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSUE8k13RObYNxDhgbN8atdNVVOXKBFYt_l8LrMHkDFRgXStumRdZXmlFn&s=10",
...
// Deterministic pseudo-random value in [0, 1) so scatter positions stay stable.
const hash = (n: number) => {
...
export default function IntroAnimation() {
    ...
    useEffect(() => {
        ...
        const handleWheel = (e: WheelEvent) => {
            // Only own the scroll while the hero still fills the viewport.
            if (!isActive()) return;
    ...
    const scatterPositions = useMemo(() => {
        return IMAGES.map((_, i) => ({
            x: (hash(i * 3) - 0.5) * 1500,
            y: (hash(i * 5 + 1) - 0.5) * 1000,
            rotation: (hash(i * 7 + 2) - 0.5) * 180,
            scale: 0.6,
            opacity: 0,
        }));
    }, []);
